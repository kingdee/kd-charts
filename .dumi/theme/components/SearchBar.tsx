...
export const highlight = (key: string, title: string) => {
  ...
  return (
    <>
      ...
      <span className="__dumi-kdesign-search-highlight">{title.substring(index, index + l)}</span>
...
export default () => {
  ...
  const emptySvg = (
    <svg
      className="__dumi-kdesign-search-empty"
  ...
  return (
    <div className="__dumi-kdesign-search">
      <input
        className="__dumi-kdesign-search-input"
        type="search"
        ref={input}
