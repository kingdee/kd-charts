...
const Hero = (hero) => (
  <>
    <div className="__dumi-kdesign-layout-hero">
...
const Features = (features) => (
  <div className="__dumi-kdesign-layout-features">
    {features.map((feat) => (
      <dl
        key={feat.title}
...
const Layout: React.FC<IRouteComponentProps> = ({ children, location }) => {
  ...
  return (
    <div
      className="__dumi-kdesign-layout"
    ...
    >
      ...
      />
      {showSlugs && (
        <SlugList slugs={meta.slugs} className="__dumi-kdesign-layout-toc" />
      )}
      {showHero && Hero(meta.hero)}
      {showFeatures && Features(meta.features)}
      <div className="__dumi-kdesign-layout-content">
        {children}
        {!showHero && !showFeatures && meta.filePath && !meta.gapless && (
          <div className="__dumi-kdesign-layout-footer-meta">
            {repoPlatform && (
        ...
        {(showHero || showFeatures) && meta.footer && (
          <div
            className="__dumi-kdesign-layout-footer"
